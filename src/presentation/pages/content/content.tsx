      ...
      <main className={styles["container"]}>
        <div className={styles["container__inline-container"]}>
          <div className={styles["container__inline-container__column"]}>
            <div
              className={styles["container__inline-container__column__inline"]}
            >
              <AlarmClock
                className={
                  styles["container__inline-container__column__inline__title"]
                }
              />
              <p
                className={
            ...
            <p
              className={
                styles["container__inline-container__column__subtitle"]
              }
            >
        ...
        <div className={styles["container__carouselContainer"]}>
          <div
            className={styles["container__carouselContainer__carouselContent"]}
          >
            <CardScheedule
              type="Revisão"
              hour="7:00"
        ...
        <CardOption
          ...
          label="Conteúdo"
          href="/matters"
          description="Escolha o conteúdo e avance no estudo."
        />
        <CardOption
          icon={Hourglass}
          label="Timer/Modo Foco"
          description="Hora de focar e estudar com intenção."
        ...
        <CardOption
          ...
          label="Newsletter"
          href="/newsletter"
          description="Fique por dentro das atualidades."
        />
      </main>
    </>
  );
